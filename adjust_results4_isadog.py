...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    """           
    # Creates dictionary of dognames for quick matching to results_dic labels from real answer & classifier's answer
    dognames_dic = dict()

    # In the below Reading in dognames from file, 1 name per line & automatically closes file
    with open(dogfile, "r") as infile:
        # Now Reading the dognames from first line in given file
        line = infile.readline()

        # Processes each line in file until reaching the ends of file
